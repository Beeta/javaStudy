...
/**
 * Created by Casey on 2017/5/11 14:48.
 */
...
//        delete();    //删除记录
    ...
    public static void query() {
        ...
        conn = getConnection();    //同样先要获取连接，即连接到数据库
        try {
            String sql = "select * from mining_desdes limit 10";        // 查询数据的sql语句
            st = (Statement) conn.createStatement();    //创建用于执行静态sql语句的Statement对象，st属局部变量
...
//                        + " " + depart + " " + worklen + " " + wage);
    ...
    private static Connection getConnection() {
        ...
        try {
            ...
            con = DriverManager.getConnection("jdbc:mysql://192.168.4.225:21406/wh_wallet", "blueRead", "O3NZVNmFdG1pPAkBiFWlYfF1HIsIbR5Z");// 创建数据连接
        } catch (Exception e) {
